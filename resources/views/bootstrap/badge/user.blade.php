...
{!! getIconHtml('streamline.bold.lock-unlock', 18, Color::CURRENT, Color::SUCCESS, 'nav-link-icon') !!}
<span class="badge text-bg-success {{ $roundedPill }} {{ $msAuto }} {{ $classList }}">{{ __('omx-support::pageDefault.badge.user') }}</span>
